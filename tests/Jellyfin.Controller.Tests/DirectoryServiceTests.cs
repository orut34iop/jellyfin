...
namespace Jellyfin.Controller.Tests
{
    public class DirectoryServiceTests
    {
        ...
        public void GetFileSystemEntries_WhenSkippingVideoSymlinkResolution_UsesFileSystemOption()
        {
            ...
            fileSystemMock.Setup(f => f.GetFileSystemEntries(It.Is<string>(x => x == _upperCasePath), false, true)).Returns(_upperCaseFileSystemMetadata);
            var directoryService = new DirectoryService(fileSystemMock.Object, true);

            var result = directoryService.GetFileSystemEntries(_upperCasePath);
